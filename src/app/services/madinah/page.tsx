...
export const metadata = {
  title: "نقل الأثاث في المدينة المنورة - شركة الصابرين",
  description:
    "شركة الصابرين تقدم خدمات نقل الأثاث داخل وخارج المدينة المنورة بأعلى معايير الجودة، مع توفير حلول شحن، تخزين، وتغليف متميزة.",
  keywords: [
    "نقل الأثاث في المدينة المنورة",
    "شحن الأثاث في المدينة المنورة",
    "نقل العفش داخل المدينة المنورة",
    "نقل الشركات والمكاتب في المدينة المنورة",
    "تخزين الأثاث في المدينة المنورة",
    "فك وتركيب الأثاث في المدينة المنورة",
    "خدمات التعبئة والتغليف في المدينة المنورة",
  ],
  openGraph: {
    title: "نقل الأثاث في المدينة المنورة - شركة الصابرين",
    description:
      "شركة الصابرين تقدم خدمات نقل الأثاث داخل وخارج المدينة المنورة بأعلى معايير الجودة، مع توفير حلول شحن، تخزين، وتغليف متميزة.",
    url: "https://al-sabreentransport.com/services/medina",
    images: [
      {
        url: "../../../assets/images/شحن المدينه المنوره .jpg",
        width: 1200,
        height: 630,
        alt: "نقل الأثاث في المدينة المنورة",
      },
    ],
    type: "website",
  },
